...
{
    public class ExpedienteJuridicoCarga
    {
        ...
        public string? FechaTranspasoJuridico { get; set; }
        public string? FechaTranspasoExterno { get; set; }
        ...
        public string? TieneImagenDirecta { get; set; }
        public string? TieneImagenIndirecta { get; set; }
        public string? TieneImagenExpediente { get; set; }
    }
}
