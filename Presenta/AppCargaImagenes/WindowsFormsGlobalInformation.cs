...
public class WindowsFormsGlobalInformation
{
    ...
    private ICargaImagenes _cargaImagenes;
    ...
    public ICargaImagenes ActivaCargaImagenesService()
    {
        try
        {
            if (_cargaImagenes != null)
                return _cargaImagenes;
            if (_host != null)
            {
                ...
                if (mainAssembly != null)
                {
                    ...
                    if (tipoCarga != null)
                    {
                        _cargaImagenes = (ICargaImagenes)ActivatorUtilities.CreateInstance(_host.Services, tipoCarga);
                    }
                }
            }
            if (_cargaImagenes is null)
            {
