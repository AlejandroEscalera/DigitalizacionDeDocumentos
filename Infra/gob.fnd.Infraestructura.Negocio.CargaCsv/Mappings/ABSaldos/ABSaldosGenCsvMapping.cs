...
{
    public class ABSaldosGenCsvMapping : CsvMapping<ABSaldosGenCarga>
    {
        public ABSaldosGenCsvMapping()
            : base()
        {
            ...
            MapProperty(21, p => p.FechaApertura);
            MapProperty(22, p => p.FechaVencim);
            ...
            MapProperty(98, p => p.CobroInt);
            MapProperty(99, p => p.CobroCapital);
            MapProperty(100, p => p.FolioAserca);
            MapProperty(101, p => p.CredDemandado);
            MapProperty(102, p => p.ImpPgsCredmnd);
            MapProperty(103, p => p.FactorSobretasa);
            MapProperty(104, p => p.TipoCalculo);
            MapProperty(105, p => p.Sobretasa);
            MapProperty(106, p => p.Medida);
            MapProperty(107, p => p.Numprom);
            MapProperty(108, p => p.Nomprom);
            MapProperty(109, p => p.CuotasMora);
            MapProperty(110, p => p.Capital);
            MapProperty(111, p => p.Interes);
            MapProperty(112, p => p.Subtotal);
            MapProperty(113, p => p.Moratorios);
            MapProperty(114, p => p.Total);
            MapProperty(115, p => p.V2601Pt);
            MapProperty(116, p => p.TipoCambio);
            MapProperty(117, p => p.CapitalVal);
            MapProperty(118, p => p.InteresVal);
            MapProperty(119, p => p.SubtotalVal);
            MapProperty(120, p => p.MoratoriosVal);
            MapProperty(121, p => p.TotalVal);
            MapProperty(122, p => p.V2601PtVal);
            MapProperty(123, p => p.MontoDisponible);
            MapProperty(124, p => p.ApoyoFirco);
            MapProperty(125, p => p.FechaApyfirco);
            MapProperty(126, p => p.IntCobAnt2601);
            MapProperty(127, p => p.FechaEmision);
            MapProperty(128, p => p.NumCreditoFira);
            MapProperty(129, p => p.NumControlFira);
            MapProperty(130, p => p.Almacenadora);
