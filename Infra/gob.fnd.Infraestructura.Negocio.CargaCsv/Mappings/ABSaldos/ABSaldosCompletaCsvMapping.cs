...
{
    public class ABSaldosCompletaCsvMapping : CsvMapping<ABSaldosCompletaCarga>
    {
        public ABSaldosCompletaCsvMapping()
            : base()
        {
            ...
            MapProperty(95, p => p.FolioAserca);
            MapProperty(96, p => p.CredDemandado);
            MapProperty(97, p => p.ImpPgsCredmnd);
            MapProperty(98, p => p.NumCreditoFira);
            MapProperty(99, p => p.NumControlFira);
        }
    }
}
